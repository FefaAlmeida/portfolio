...
export default function Home() {
  return (
    <>
      ...
      {/* SEÇÃO DE PROJETOS */}
      <section id="projetos" className="relative w-full bg-neutral-900 text-[#f4eee1] py-20 px-6 sm:px-12 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto space-y-12">
          ...
          <div className="border-b border-[#a38f7e]/20 pb-8 space-y-3">
            <span className="text-xs sm:text-sm font-semibold uppercase tracking-[0.25em] text-[#a38f7e] block">
            ...
            <p className="text-sm sm:text-base text-[#a38f7e] font-normal leading-relaxed max-w-2xl pt-2">
